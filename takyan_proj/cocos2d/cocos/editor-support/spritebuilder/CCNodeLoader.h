...
#define COLOR4F_TO_COLOR4B(X) (Color4B(X.r * 255, X.g * 255, X.b * 255, X.a * 255))
#define COLOR4F_TO_COLOR3B(X) (Color3B(X.r * 255, X.g * 255, X.b * 255))
struct BlockData {
...
class NodeLoader : public cocos2d::Ref {
    ...
    protected:
        ...
        virtual cocos2d::Color4F parsePropTypeColor4(cocos2d::Node * pNode, cocos2d::Node * pParent, CCBReader * ccbReader, const char *pPropertyName);
        ...
        virtual float * parsePropTypeFloatXY(cocos2d::Node * pNode, cocos2d::Node * pParent, CCBReader * ccbReader); // FIXME: apply effects when supported
    
        virtual void readEffects(cocos2d::Node * pNode, cocos2d::Node * pParent, CCBReader * ccbReader);
        ...
        virtual void onHandlePropTypeColor4(cocos2d::Node * pNode, cocos2d::Node * pParent, const char* pPropertyName, cocos2d::Color4F pColor3B, CCBReader * ccbReader);
